...
namespace _21century
{
    public class Pager
    {
        ...
        protected List<string> GetLinks(int countItem, int currentPage, int itemsPerPage, int links_visible, System.Collections.Specialized.NameValueCollection query)
        {
            ...
            int countPages = (int)Math.Ceiling((double)countItem / (double)itemsPerPage);
